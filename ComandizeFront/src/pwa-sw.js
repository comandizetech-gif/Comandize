...
// Não deixa o Service Worker interferir em API nem imagens enviadas.
// Isso evita cache antigo/quebrado em /uploads/products.
...
self.addEventListener("push", (event) => {
  ...
  try {
    ...
    data = {
      title: "Novo pedido COMANDIZE",
      body: event.data?.text() || "Você recebeu um novo pedido.",
    };
  }
